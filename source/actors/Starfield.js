...
(function (Alpha) {
    ...
    Alpha.Star.prototype.initialize = function (game) {
    ...
    Alpha.Star.prototype.update = function (game) {
    ...
    Alpha.Star.prototype.draw = function (context) {
    ...
    Alpha.Starfield.prototype.initialize = function (game) {
    ...
    Alpha.Starfield.prototype.update = function (game) {
        if (0 === this.cooldown) {
            for (var i = 0; i < game.config.get('Starfield.DENSITY'); i++) {
                game.stage.addActor(new Alpha.Star());
            }
